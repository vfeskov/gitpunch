...
export function EyeIcon (className) {
  return (
    <svg aria-hidden="true" className={className} height="16" version="1.1" viewBox="0 0 16 16" width="16">
...
export function ForkIcon (className) {
  return (
    <svg aria-hidden="true" className={className} height="16" version="1.1" viewBox="0 0 10 16" width="10">
